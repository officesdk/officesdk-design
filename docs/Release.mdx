...
This document describes the release process for `@officesdk/design`.
...
# ? What kind of change is this for @officesdk/design?
...
1. **Verify on NPM**: https://www.npmjs.com/package/@officesdk/design
2. **Check Storybook**: https://officesdk.github.io/officesdk-design
